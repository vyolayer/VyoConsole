                ...
                <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
                    ...
                    <div className="space-y-8">
                        ...
                        <p className="max-w-lg text-lg leading-relaxed text-muted-foreground md:text-xl">
                            Authentication, RBAC, audit logs, and project-scoped APIs — pre-built so
                            your team can ship internal tools{" "}
                            <strong className="text-foreground">in hours, not weeks</strong>.
                        </p>

                        <div className="flex flex-wrap items-center gap-4">
                            <Link href="/auth/register">
                                <Button size="lg" className="group gap-2 text-base cursor-pointer">
                                    Get Started
                    ...
                    <div className="landing-hero-card relative rounded-xl border border-border/50 bg-card/60 p-1 shadow-2xl backdrop-blur-sm">
                        ...
                        <pre className="overflow-x-auto p-5 text-sm leading-relaxed bg-transparent! rounded-none!">
                            <code className="bg-transparent! p-0! text-foreground/90 font-mono">
                                {HERO_CODE}
                            </code>
                        </pre>
                    </div>

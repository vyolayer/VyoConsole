...
export const FEATURES = [
    ...
    },
    {
        ...
        description:
            "Fine-grained RBAC with organization-level roles and permissions across every resource.",
    },
    {
        icon: ScrollText,
        title: "Audit Logs",
    ...
    },
    {
        ...
        title: "API Keys",
        description:
            "Scoped API keys for programmatic access. Rotate, revoke, and manage them from the console.",
    },
    {
        icon: Database,
        title: "Project-Scoped APIs",
        description:
            "Data APIs scoped to projects — no custom backend needed. Build internal dashboards in hours.",
    },
    {
        icon: Building2,
        title: "Organizations",
        description:
            "Multi-tenant org management with invitations, member control, and team-level governance.",
    },
];
